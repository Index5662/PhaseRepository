...
while i <= 44:           #0 = number of loops +1  or  #0 = number of pages +1
 i = i + 1   
 print(i)
 time.sleep(0)

 response = requests.get("https://bid.centurionservice.com/auctions/catalog/id/383?page=1" + """str(i)""")           #Link Goes Here
